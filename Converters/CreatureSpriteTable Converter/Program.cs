...
namespace CreatureSpriteTable_Converter
{
    class Program
    {
        ...
        static CreatureSpriteTable JsonToZoneTable(string json)
        {
            Console.WriteLine("Deserializing JSON File. Please Wait.");
            CreatureSpriteTable tl = JsonConvert.DeserializeObject<CreatureSpriteTable>(json);
